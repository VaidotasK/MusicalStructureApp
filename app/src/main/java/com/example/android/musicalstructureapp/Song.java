...
public class Song {
     ...
     * @param imageResourceId is the drawable resource ID for the image artwork associated with the song
     */
    public Song(String songTitle, String artist, int imageResourceId) {
        mSongTitle = songTitle;
        mArtist = artist;
        mImageResourceId = imageResourceId;
    }
    ...
    /**
     * Create a new com.example.android.musicalstructureapp.Songs object for Artists list.
     *
     * @param artist
     * @param imageResourceId is the drawable resource ID for the image artwork associated with the song
     */
    public Song(String artist, int imageResourceId) {
        mArtist = artist;
        mImageResourceId = imageResourceId;
    }
