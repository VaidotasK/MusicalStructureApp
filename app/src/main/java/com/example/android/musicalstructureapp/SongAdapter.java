    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listItemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                nowPlayingSongIntent.putExtra("currentSong", currentSong.getSongTitle());
                nowPlayingSongIntent.putExtra("currentAuthor", currentSong.getArtist());

                if (currentSong.hasAlbumTitle()) {
                    nowPlayingSongIntent.putExtra("currentAlbumTitle", currentSong.getAlbumTitle());
                } else {
                    nowPlayingSongIntent.putExtra("currentAlbumTitle", "");
                }


                if (currentSong.hasImage()) {
                    nowPlayingSongIntent.putExtra("currentArtWork", currentSong.getImageResourceId());
                } else {
                    nowPlayingSongIntent.putExtra("currentArtWork", R.drawable.icon_album_artwork_default_48px);
                }
